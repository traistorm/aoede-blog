    ...
    return (
        <>
            <section className="bg-gray-100 min-h-screen flex box-border justify-center items-center">
                <div className="m-5 bg-[#dfa674] rounded-2xl flex max-w-3xl p-5 items-center">
                    {
                        isLoginPanel && (
                                ...
                                <form action="" className="flex flex-col gap-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <svg
                                            ...
                                            fill="gray"
                                            id="togglePassword"
                                            className={`bi bi-eye absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer z-20 ${showPassword ? 'hidden' : 'block'}`}
                                            viewBox="0 0 16 16"
                                        ...
                                        <svg
                                            ...
                                            height="16"
                                            fill="currentColor"
                                            className={`bi bi-eye-slash-fill absolute top-1/2 right-3 -z-1 -translate-y-1/2 cursor-pointer ${showPassword ? 'block' : 'hidden'}`}
                                            id="mama"
                                            viewBox="0 0 16 16"
                                            onClick={togglePassword}
                                        >
                    ...
                    }
                    {
                        !isLoginPanel && (
                            <div className="md:w-1/2 px-8">
                                ...
                                <p className="text-sm mt-4 text-[#002D74]">Sign up for an account here to post, comment and more.</p>
                                ...
                                <div className="mt-4 text-sm flex justify-between items-center container-mr">
                                    ...
                                    <button onClick={() => {setIsLoginPanel(true)}} className="hover:border register text-white bg-[#002D74] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300">Login</button>
                                </div>
                            </div>
                        )
                    }
